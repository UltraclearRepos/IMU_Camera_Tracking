...
def print_map_build_timing(timing):
    ...
    print("  ONLINE FRONTEND - executed while frames arrive")
...
class SkinMapBuilder:
    ...
    def collect_and_match_mapping_frames(
        ...
        for frame_index in range(
            ...
            print(
                f"Online mapping frontend: frame {frame_index}/"
    ...
    def create_global_map(
        ...
        for point in reconstruction.points3D.values():
            ...
            first_observation_frames.append(
                min(
                    frame_number(
    ...
    def build(self, video_path, output_dir):
        ...
        online_wall_seconds = frontend_statistics[
            "online_frontend_wall_seconds"
        ]
        timing = {
            "online_frontend": {
                "processed_frames": processed_frames,
                "attempted_pairs": frontend_statistics[
                    "attempted_pairs"
                ],
                "verified_pairs": frontend_statistics[
                    "verified_pairs"
                ],
                "setup_s": frontend_statistics["setup_seconds"],
                "frame_read_s": frontend_statistics[
                    "frame_read_seconds"
                ],
                "image_save_s": frontend_statistics[
                    "image_save_seconds"
                ],
                "disk_and_feature_selection_s": frontend_statistics[
                    "disk_and_selection_seconds"
                ],
                "aruco_detection_s": frontend_statistics[
                    "aruco_detection_seconds"
                ],
                "image_and_keypoints_database_write_s": (
                    frontend_statistics["image_database_write_seconds"]
                ),
                "lightglue_matching_s": frontend_statistics[
                    "lightglue_seconds"
                ],
                "pair_geometry_verification_s": frontend_statistics[
                    "geometry_verification_seconds"
                ],
                "verified_pair_database_write_s": frontend_statistics[
                    "pair_database_write_seconds"
                ],
        ...
        summary = {
            ...
            "verified_image_pairs": frontend_statistics[
                "verified_pairs"
            ],
